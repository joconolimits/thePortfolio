...
namespace ThePortfolio.Controllers
{
    public class JournalItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Description,ItemUrl")] JournalItem journalItem, HttpPostedFileBase Image)
        {
            if (Image != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Description,ItemUrl")] JournalItem journalItem, HttpPostedFileBase Image)
        {
